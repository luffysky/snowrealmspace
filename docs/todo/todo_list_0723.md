> ⛔ **此檔已被 `todo_list_0724.md` 取代**（2026-07-24）。請改看 **docs/todo/todo_list_0724.md ＝現行主檔**。本檔留作歷史，不刪。
>
> ✅ **2026-07-24 核對：本檔所有未完成項目已全數沿用至 0724。** 對照結果：
> - Milestone C/D/E 的功能待辦 → 0724 已全數完成或列為進行中（C1–C7、D 路由+對話+工具+記憶、E cron+weekly recap）。
> - B 剩餘（台北黑體、poster frame、Q10）、F（Figma 憑證）、隱私刪除組（空間/帳號刪除、匯出）→ 0724 對應區塊皆有。
> - 外部卡住項（R2、Zeabur worker、AI 金鑰、Google/LINE 憑證+隱私權政策頁、Figma 憑證、字體檔）→ 0724 的 🔴 區已補齊。
> - 決定項（Agent 名字/外觀、生日鏈第 5 環、產品名稱；背景音樂已完成）、小技術債 → 0724 已納入。
> **下面保留 0723 原文當歷史快照，狀態以 0724 為準。**
