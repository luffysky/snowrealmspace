/**
 * 天氣 condition → Meteocons 動畫圖示的純對應與懶載入。
 *
 * 素材為 Meteocons（Bas Milius，MIT）——見同資料夾 LICENSE.md。JSON 隨專案打包，
 * 與 lib/lottie-scenes.ts 相同：位元組屬「明確授權的內建素材」，非使用者檔案，符合 ADR-005。
 *
 ...
 * 有日夜之分的用 -day / -night，其餘（雨、雪、颱風…）日夜共用一張。
 */
