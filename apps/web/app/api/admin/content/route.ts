...
const KINDS = ['quote', 'prompt', 'question', 'micro_action', 'seasonal', 'greeting', 'surprise', 'chain'] as const

const postSchema = z
  .object({
    kind: z.enum(['quote', 'prompt', 'question', 'micro_action', 'seasonal', 'greeting', 'surprise']),
